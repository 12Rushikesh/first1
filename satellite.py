...
#Loading the libararies we need : numpy ,scipy, matplotlib
import numpy as np
import scipy
import imageio
...
#lets choose a WIFIRE satelite image file as an ndarray and displayits type

from skimage import data
photo_data =imageio.imread('D:/Python/ML projects/data/sd-3layers.jpg')
type(photo_data)
...
photo_data.mean() #Average pixels value

# Pixel on the 150th Row and 250th column:
photo_data[150, 250] # It will print the Red , Green , and Blue values in order

photo_data[150 , 250, 1] # It will print out the green value

#pixel on the 2nd Row and 2nd column:
photo_data[1,1] # It will print the Red , Green , Blue values order
...
print("center_row =",center_row, "And total_col =",center_col)
